...
public:
    string addStrings(string num1, string num2) 
    {
        ...
        while(1)
        {
            ...
            {
                int start_index = num1_length - num1_read_count - 1;
                //20ms, 9.4mb
                //dec1 = string_to_int(num1.substr(start_index, 1));
                //20ms, 9.2mb
                dec1 = char_to_int(num1[start_index]);
            ...
            {
                int start_index = num2_length - num2_read_count - 1;
                //20ms, 9.4mb
                //dec2 = string_to_int(num2.substr(start_index, 1));
                //20ms, 9.2mb
                dec2 = char_to_int(num2[start_index]);
                //cout << "dec2 = " << dec2 << endl;
                num2_read_count++;
            }
            sum = dec1 + dec2 + carry;
